    ...
    <div className='h-screen'>
        ...
        <div className='md:grid grid-cols-2 gap-5 mt-5'>
            <div className='md:pl-0 pl-8'>
                <img src={detail.image} alt="" className='md:w-[300px] md:h-[300px] h-[200] w-[300px] '/>
            </div>
            <div className='flex flex-col gap-5'>
                <h1 className='text-4xl uppercase font-bold md:pl-0 pl-4'>{detail.name}</h1>
                <p className='font-bold text-3xl'>
                    ${detail.price}
                </p>
                <div className='flex gap-5 md:ml-0 ml-8'>
